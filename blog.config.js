...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '洋洋少', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一生所求，爱与自由！——洋少', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://yyshao.icu', // 网站地址
